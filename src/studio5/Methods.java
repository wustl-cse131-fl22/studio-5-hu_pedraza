...
public class Methods {
	...
	public static void drawBullsEye(double x, double y, double radius) {
		...
		double radiusBlue = 3.0/4.0 * radius;
		StdDraw.setPenColor(StdDraw.BLUE);
		StdDraw.filledCircle(x, y, radiusBlue);


		// Red ring with 1.0/2.0 the radius
		// suggested rgb values: 146, 0, 0
		double radiusRed = 1.0/2.0 * radius;
		StdDraw.setPenColor(StdDraw.RED);
		StdDraw.filledCircle(x, y, radiusRed);

		

		// Yellow ring with 1.0/4.0 the radius
		// suggested rgb values: 255, 255, 109
		double radiusYellow = 1.0/4.0 * radius;
		StdDraw.setPenColor(StdDraw.YELLOW);
		StdDraw.filledCircle(x, y, radiusYellow);
	}
	...
	/**
	 * Return the mean	` of a given array of integers
	 * 
	 * @param values an array of integers
